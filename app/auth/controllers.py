...
class UserRegisterBodySchema(Schema):
  first_name = fields.String(required=True, validate=[validate.Length(min=2, max=20), validate.Regexp(r'^[a-zA-Z-\s]+$')])
  last_name = fields.String(required=True, validate=[validate.Length(min=2, max=20), validate.Regexp(r'^[a-zA-Z-\s]+$')])
